...
const Cart = () => {
    ...
    return (
        <>
            <button onClick={clearCartProduct} className='btn btn-danger text-white d-block ms-auto my-3'>Clear Cart</button>
            {errorMessage ?
                ...
                products.map((product, index) => {
                    return <div className="row p-2 my-3 shadow rounded-2 align-items-center">
                        ...
                        <div className="col-md-2">
                            <button onClick={() => removeCartProduct(product.product._id)} className='btn btn-danger text-white d-block mb-5'>Remove</button>
